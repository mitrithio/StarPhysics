...
PhysicComponent::PhysicComponent(PCEPoint3D i_position, double i_rotation, bool i_isEnabled /* = true */, PositionableObject * i_owner /* = nullptr */)
...
void PhysicComponent::update(double i_deltaTime /* = 0 */)
{
